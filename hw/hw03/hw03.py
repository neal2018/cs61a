...
def count_change(total):
    ...
    True
    """
    def helper(n, m):  # loosely smaller
        if n == 0:
            return 1
        elif n < 0:
            return 0
...
def make_anonymous_factorial():
    ...
    """
    # it's too hard...
    return (lambda f: (lambda x, f=f: f(f, x)))(lambda g, n1: 1 if n1 == 0 else mul(n1, g(g, sub(n1, 1))))
